...
driver = webdriver.Chrome(executable_path="C:\Users\BDCVa\.jenkins\workspace\Python_WeatherForecaste\drivers\chromedriver.exe")
...
message = """\
Subject: Bangalore Weather forecast from Dilli code
